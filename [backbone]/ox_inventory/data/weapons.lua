return {
	Weapons = {
		...
		['WEAPON_FLASHLIGHT'] = {
			...
			weight = 125,
			durability = 0.1,
			anim = { 'reaction@intimidation@cop@unarmed', 'intro', 400, 'reaction@intimidation@cop@unarmed', 'outro', 450 },
		},
		...
		['WEAPON_PUMPSHOTGUN_MK2'] = {
			label = 'Police Shotgun',
			weight = 500,
			durability = 0.1,
			ammoname = 'ammo-shotgunlrg'
		},
...
-- Modlular
		...
		['susturucu'] = {
			...
			client = {
				component = {
					...
					`COMPONENT_M6IC_SUPP_02`,
					`COMPONENT_MPX_BARREL_03`,
				},
		...
		['scope'] = {
			...
			client = {
				component = {
					`COMPONENT_MPX_SCOPE_05`,
					`COMPONENT_M6IC_SCOPE_09`,
					`COMPONENT_SCARSC_SCOPE_03`,
		...
		['grip'] = {
			...
			client = {
				component = {
					...
					`COMPONENT_SCARSC_STOCK_03`,
					`COMPONENT_M6IC_STOCK_08`,
					`COMPONENT_MPX_HANDGUARD_03`,
					`COMPONENT_AT_AR_AFGRIP_02`,
					`COMPONENT_AT_AR_AFGRIP_02`,
					`COMPONENT_AT_AR_AFGRIP_02`,
					`COMPONENT_AT_AR_AFGRIP_02`,
	...
	Ammo = {
		...
		['ammo-smglrg'] = {
			label = 'PD SMG Mermisi',
			weight = 1000,
		},

		['ammo-smg'] = {
			label = 'SMG Mermi Kutusu',
			weight = 1000,
		},
