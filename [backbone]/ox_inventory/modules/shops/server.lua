			...
			if toData == nil or (fromItem.name == toItem?.name and fromItem.stack and table.matches(toData.metadata, metadata)) then
				...
				-- if server.loglevel > 0 then
					...
					-- print(6)
						...
						local Player = QBCore.Functions.GetPlayerByCitizenId(playerInv.owner)
						...
						embed = {{
							...
							["fields"] = {
								...
								[8] = {
									["name"] = "Satın Aldığı İtem",
									["value"] = ""..fromItem.label,
									["inline"] = true
								},
								[9] = {
									["name"] = "Satın Aldığı Miktar",
									["value"] = ""..count,
									["inline"] = true
								},
								[10] = {
