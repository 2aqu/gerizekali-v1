...
RegisterNetEvent('v4-carspray:client:usedSpray', function(i)
...
function applyPaint(veh, i)
    ...
    DeleteEntity(sprayProp)
    FreezeEntityPosition(veh, false)
    TriggerServerEvent('v4-carspray:client:finishedSpray', QBCore.Functions.GetVehicleProperties(veh), i)
end