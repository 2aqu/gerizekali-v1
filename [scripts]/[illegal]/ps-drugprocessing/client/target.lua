...
CreateThread(function()
        ...
        options = {
            {
                ...
                icon = "fas fa-weight-scale", --<i class="fa-solid fa-cannabis"></i>
                label = Lang:t("target.bagging"),
                --job = "cokecutter", -- Remove this line if you do not want a job check.
            },
        },
    ...
    exports["qb-target"]:AddBoxZone("weedproces", vector3(3680.66, 4571.48, 25.09), 2.5, 2.5, {
        name = "weedproces",
        heading = 331.74,
        debugPoly = false,
        minZ = 20.99,
	...
	exports["qb-target"]:AddBoxZone("heroinproces", vector3(557.5, 2665.81, 42.18), 2.5, 2.5, {
        name = "heroinproces",
        heading = 223.98,
        debugPoly = false,
        minZ = 40.21,
    ...
    exports['qb-target']:AddBoxZone("heroinproc", vector3(1321.51, 4314.54, 38.33), 1, 1, {--1321.51, 4314.54, 38.33, 85.81
		name="heroinproc",
		heading=85.81,
		debugPoly=false,
		minZ = 31.00,
