...
Config.CircleZones = {
	WeedField = {coords = vector3(0.0, 0.0, 0.0), name = ('Weed Farm'), radius = 100.0},
	WeedProcessing = {coords = vector3(0.0, 0.0, 0.0), name = ('Weed Process'), radius = 100.0},
	...
	CokeField = {coords = vector3(10.8629, 6867.9565, 12.5953), name = ('Kokain'), radius = 100.0},
	...
	HeroinField = {coords = vector3(1060.69, 4259.44, 37.77), name = ('Heroin'), radius = 100.0}, --vector4(1060.69, 4259.44, 37.77, 20.59)
	HeroinProcessing = {coords = vector3(1321.51, 4314.54, 38.33), name = ('Heroin Process'), radius = 100.0}, --vector4(1321.51, 4314.54, 38.33, 85.81)

	lsdProcessing = {coords = vector3(2899.11, 4399.43, 50.23), name = ('LSD process'), radius = 100.0},
...
Config.CokeProcessing = {
	...
	ProcessCokeLeaf = math.random(10,10), -- Amount of Coke Received
	-- Processing Small Bricks --
	Coke = 10, -- Amount of Coke Needed for Small Brick
	BakingSoda = 1, -- Amount of Baking Soda Needed for Small Brick
	SmallCokeBrick = math.random(4,4),
...
Config.MethProcessing = {
	...
	Meth = math.random(10,10), -- Amount of Meth Recevied From 1 Tray
}
...
Config.HeroinProcessing = {
	Poppy = 1 -- Amount of Poppy Required for 1 Heroin
}