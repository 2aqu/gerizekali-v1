...
Config.PedMenuGroup = "qbcore.admin"
...
Config.Stores = {
    ...
    {
        type = "clothing", --vpd
        coords = vec3(624.73400878906,1.6291046142578,77.22110748291),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        type = "clothing",
        coords = vector3(-41.88, -1064.37, 28.4),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        type = "clothing", -- Motel
        coords = vector4(-2957.07, 28.81, 7.97, 237.38),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(-2961.97, 22.11, 7.98),
            vector3(-2949.64, 16.63, 8.78),
            vector3(-2944.81, 26.34, 7.97),
            vector3(-2956.46, 33.4, 7.98)
        }
    },
    {
        type = "barber", -- Unicorn
        coords = vector4(103.0984, -1298.4268, 28.7690, 293.1408),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(103.1009, -1298.4268, 28.6265)
        }
    },
    {
        type = "barber",
    ...
    {
        type = "barber", -- MOTEL
        coords = vector4(-2899.18, 0.52, 7.98, 346.21),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(-2897.78, -5.45, 8.03),
            vector3(-2901.87, -3.06, 7.98),
            vector3(-2899.36, 5.23, 8.07),
            vector3(-2895.12, 4.63, 7.98)
        }
    },
    {
        type = "tattoo",
    ...
    {
        type = "tattoo", -- MOTEL
        coords = vector4(-2908.29, 1.41, 7.97, 240.38),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(-2910.61, 3.7, 7.97),
            vector3(-2904.51, 1.26, 7.97),
            vector3(-2905.34, -1.39, 7.99),
            vector3(-2911.98, -0.29, 7.97)
        }
    },
    -- {
    --     type = "surgeon",
    --     coords = vector4(-75.12, -818.47, 326.18, 174.46),
    --     size = vector3(4, 4, 4),
    --     rotation = 45,
    --     usePoly = false,
    --     points = {
...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vector4(461.1777, -997.4063, 31.1403, 229.4859),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
    },
    {
        job = "police",
        coords = vector4(604.4, -7.05, 87.82, 337.59),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
    },
    {
        job = "police",
        coords = vector4(846.4897, -1283.6504, 24.3124, 346.8996),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
    },
    {
        job = "police",
        coords = vector4(386.66, 794.42, 190.49, 2.48),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
    },
    {
        job = "police",
        coords = vector4(1839.0092773438,3678.0476074219,38.929302215576,95.443290710449),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
    },
    {
        job = "police",
        coords = vector4(362.4933, -1593.4662, 25.4517, 287.4742),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
    },
    {
        job = "ambulance",
        coords = vector4(300.75, -597.11, 43.28, 345.23),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
    },
    {
        job = "reporter",
        coords = vector4(-583.90478515625,-937.68981933594,23.869632720947,72.402565002441),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
    },
    {
        job = "unicorn",
        coords = vector4(105.6407, -1303.1345, 28.7930, 295.8429),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
    },
