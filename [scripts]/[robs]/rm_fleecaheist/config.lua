...
Config['FleecaMain'] = {
    ...
    rewardItems = {
        ...
        cashTrolly = { 
            item = nil, -- cash
            count = 100,
            multiGrabCount = 150000, -- middle main grab
        },
        lockbox = function()
...
Strings = {
    ['wait_nextheist'] = 'Şuan olmaz',
    ['minute'] = 'dakika.',
    ['need_item'] = 'Bu yok: ',
    ['police_alert'] = 'Fleeca banka soygunu alarmı! gpsinizi kontrol edin.',
    ['drill'] = 'Herşeyi Aldın',
    ['grab_trolly'] = 'Toplamak için ~INPUT_CONTEXT~',
    ['grab'] = 'Toplamak için ~INPUT_CONTEXT~',
    ['deliver_to_buyer'] = '-.',
    ['buyer_blip'] = 'Buyer',
    ['need_police'] = 'Yeterli polis yok.',
    ['total_money'] = 'Toplam para: '
}
