...
Config.BillCost = 25 -- Price that players are charged for using the hospital check-in system
...
Config.HealthDamage = 999 -- Minumum damage done to health before checking for injuries
Config.ArmorDamage = 999 -- Minumum damage done to armor before checking for injuries
Config.ForceInjury = 999 -- Maximum amount of damage a player can take before limb damage & effects are forced to occur
...
Config.HeadInjuryChance = 0 -- The chance, in percent, that head injury side-effects get applied
Config.LegInjuryChance = { -- The chance, in percent, that leg injury side-effects get applied
    Running = 0,
    Walking = 0
}
Config.MajorArmoredBleedChance = 0 -- The chance, in percent, that a player will get a bleed effect when taking heavy damage while wearing armor
Config.MaxInjuryChanceMulti = 0 -- How many times the HealthDamage value above can divide into damage taken before damage is forced to be applied
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    [1] = vector3(307.67, -595.52, 43.1),
    },
    ["duty"] = {
        [1] = vector3(312.25, -593.54, 43.37),
    },
    ["vehicle"] = {

    },
    ["helicopter"] = {
        [1] = vector4(351.92, -588.21, 74.16, 68.55),
    },
    ["armory"] = {
        [1] = vector3(306.82, -601.84, 43.28),
    },
    ["roof"] = {
        [1] = vector3(332.33, -595.73, 43.28),
    },
    ["main"] = {
        [1] = vector3(338.6, -583.87, 74.16),
    },
    ["stash"] = {
        [1] = vector3(304.12, -599.51, 43.28),
    },
    ["beds"] = {
        [1] = {coords = vector4(322.62, -587.17, 42.84, 332.0), taken = false, model = 1631638868},
        [2] = {coords = vector4(317.67, -585.37, 42.84, 332.0), taken = false, model = 1631638868},
        [3] = {coords = vector4(314.47, -584.2, 42.84, 332.0), taken = false, model = 1631638868},
        [4] = {coords = vector4(311.06, -582.96, 42.84, 332.0), taken = false, model = 1631638868},
        [5] = {coords = vector4(307.72, -581.75, 42.84, 332.0), taken = false, model = 1631638868},
    ...
    ["stations"] = {
        [1] = {label = Lang:t('info.pb_hospital'), coords = vector4(297.72, -583.89, 43.26, 173.38)}
    }
}
...
Config.StaggerAreas = { -- Define body areas that will always cause staggering if wearing armor or not
    ...
    ['UPPER_BODY'] = { armored = true, major = 60, minor = 30 },
