                ...
                for k, v in pairs(result) do
                    ...
                    elseif result["WEAPONWOUNDS"] then
                        for _, v2 in pairs(result["WEAPONWOUNDS"]) do
                            QBCore.Functions.Notify(Lang:t('info.status') .. " : " .. QBCore.Shared.Weapons[v2].damagereason)
                        end
                    elseif result["BLEED"] > 0 then
                        QBCore.Functions.Notify(Lang:t('info.is_status', { status = Config.BleedingStates[v].label }))
                    else
                ...
                options = {
                    {
                        ...
                        label = "Asansör",
                        job = {["police"] = 0, ["fbi"] = 0, ["state"] = 0, ["sheriff"] = 0, ["ranger"] = 0, ["davison"] = 0, ["ambulance"] = 0},
                    },
                },
                distance = 8
            })
...
Citizen.CreateThread(function()
    ...
    local ped_hash2 = 0xD47303AC --Ped Hash Giriniz https://wiki.rage.mp/index.php?title=Peds
    local ped_coords2 = { x = 308.35, y = -595.27, z = 42.28, h = 78.9} -- Kordinat Giriniz
