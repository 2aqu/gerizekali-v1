...
local function K9AttackorFollow(target)
  ...
  if target then
    ...
    following = false
    QBCore.Functions.Notify(k9_name.." saldırıyor!", "error", 2000)
  else
...
RegisterKeyMapping('caninecommanders', 'K9 KOMUTLARI YALNIZCA POLİS', 'keyboard', 'K')
...
RegisterKeyMapping('cannineattackfollow', 'K9 KOMUTLARI YALNIZCA POLİS', 'keyboard', 'Z')
