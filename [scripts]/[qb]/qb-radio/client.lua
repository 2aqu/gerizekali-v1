...
RegisterNetEvent('setNewChannel_1')
AddEventHandler('setNewChannel_1', function()
    exports["pma-voice"]:setRadioChannel(1)
    QBCore.Functions.Notify('Telsiz kanalınız değişti. Yeni Kanal: 1', "success")
end)

RegisterNetEvent('setNewChannel_11')
AddEventHandler('setNewChannel_11', function()
    exports["pma-voice"]:setRadioChannel(1.1)
    QBCore.Functions.Notify('Telsiz kanalınız değişti. Yeni Kanal: 1.1', "success")
end)

RegisterNetEvent('setNewChannel_12')
AddEventHandler('setNewChannel_12', function()

    exports["pma-voice"]:setRadioChannel(1.2)
    QBCore.Functions.Notify('Telsiz kanalınız değişti. Yeni Kanal: 1.2', "success")
end)

RegisterNetEvent('setNewChannel_2')
AddEventHandler('setNewChannel_2', function()
    exports["pma-voice"]:setRadioChannel(2)
    QBCore.Functions.Notify('Telsiz kanalınız değişti. Yeni Kanal: 2', "success")
end)

RegisterNetEvent('setNewChannel_3')
AddEventHandler('setNewChannel_3', function()
    exports["pma-voice"]:setRadioChannel(3)
    QBCore.Functions.Notify('Telsiz kanalınız değişti. Yeni Kanal: 3', "success")
end)

RegisterNetEvent('setNewChannel_4')
AddEventHandler('setNewChannel_4', function()
    exports["pma-voice"]:setRadioChannel(4)
    QBCore.Functions.Notify('Telsiz kanalınız değişti. Yeni Kanal: 4', "success")
end)