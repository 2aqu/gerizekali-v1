...
-- uwu1 Oluşturan Emre
Config.DoorList['uwu-uwu1'] = {
    doorType = 'door',
    doorLabel = 'uwu1',
    fixText = false,
    objCoords = vec3(-587.340027, -1051.899414, 22.413006),
    authorizedJobs = { ['uwu'] = 0, ['mechanic1'] = 0, },
    locked = true,
    doorRate = 1.0,
...
Config.DoorList['uwu-uwu4'] = {
    ...
    locked = true,
    doorRate = 1.0,
    objYaw = 269.98150634766,
    distance = 2,
    objName = 522844070,
}

-- uwu5 Oluşturan Emre
Config.DoorList['uwu-uwu5'] = {
    doorType = 'door',
    doorLabel = 'uwu5',
    fixText = false,
