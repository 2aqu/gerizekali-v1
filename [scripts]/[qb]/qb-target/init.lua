...
Config.SuccessDrawColor = {255, 255, 255, 255}
...
Config.BoxZones = {
    ["arobflat2"] = {                                                                            
		name = "arobflat2",
		coords = vector3(-218.27, -1167.84, 23.02),
		length = 0.50,
		width = 0.50,
		heading = 26.0,
		debugPoly = false,
		...
		options = {
			{
				type = "client",
				event = "arob:detelecar",
				icon = "fas fa-sign-in-alt",
				label = "Aracı Çek",
				job = {["mechanic1"] = 0,["mechanic2"] = 0,["mechanic3"] = 0,["mechanic4"] = 0,["mechanic5"] = 0,["mechanic6"] = 0,["mechanic7"] = 0,["mechanic8"] = 0,["mechanic9"] = 0,["mechanic10"] = 0,["mechanic11"] = 0,["mechanic12"] = 0,},
			}
		},
		distance = 3.5
	},
...
Config.Peds = {
	[1] = {
        ...
        coords = vector4(-218.27, -1167.84, 23.02, 97.3),
        currentpednumber = 0,
        freeze = true,
        blockevents = true,
        invincible = true,
