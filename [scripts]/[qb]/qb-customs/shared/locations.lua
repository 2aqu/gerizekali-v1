...
18: Emergency   19: Military    20: Commercial  21: Trains
 ...
 Config.Locations = {
     ...
     ['mechanic15'] = {
        ...
        zones = { 
            { coords = vector3(875.86, -2125.26, 30.13), length = 6.0, width = 4.0, heading = 355.31, minZ = 28.49, maxZ = 32.0 },
            { coords = vector3(887.28, -2125.99, 30.13), length = 6.0, width = 4.0, heading = 354.94, minZ = 28.49, maxZ = 32.0 },
            { coords = vector3(897.95, -2127.02, 30.13), length = 6.0, width = 4.0, heading = 357.11, minZ = 28.49, maxZ = 32.0 },
            { coords = vector3(909.15, -2128.17, 30.13), length = 6.0, width = 4.0, heading = 352.32, minZ = 28.49, maxZ = 32.0 },
        }
        },
