...
Config.Safes = {
    ...
    [5] = {vector3(31.29, -1339.34, 29.5), type = "keypad", robbed = false, camId = 8},
    ...
    [8] = {vector3(381.11, 332.51, 103.57), type = "keypad", robbed = false, camId = 11},
    ...
    [11] = {vector3(-3048.65, 588.49, 7.91), type = "keypad", robbed = false, camId = 14},
    [12] = {vector3(-3250.02, 1004.43, 12.83), type = "keypad", robbed = false, camId = 15},
    [13] = {vector3(543.7, 2662.55, 42.16), type = "keypad", robbed = false, camId = 16},
    [14] = {vector3(2674.37, 3289.25, 55.24), type = "padlock", robbed = false, camId = 17},
    [15] = {vector3(2672.69, 3286.63, 55.24), type = "keypad", robbed = false, camId = 18},
    [16] = {vector3(1961.8, 3750.27, 32.34), type = "keypad", robbed = false, camId = 19},
    [17] = {vector3(1737.46, 6419.48, 35.04), type = "keypad", robbed = false, camId = 20},
    [18] = {vector3(-168.40, 6318.80, 30.58), type = "padlock", robbed = false, camId = 27},
    [19] = {vector3(171.03, 6642.47, 31.7), type = "keypad", robbed = false, camId = 30},
}
