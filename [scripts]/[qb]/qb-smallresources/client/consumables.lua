...
RegisterNetEvent('consumables:client:UseArmor', function()
    if GetPedArmour(PlayerPedId()) >= 75 then QBCore.Functions.Notify('Zaten yeterince zırhınız var!', 'error') return end
    QBCore.Functions.Progressbar("use_armor", "Zırh giyiyorsun....", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('consumables:client:UseHeavyArmor', function()
    ...
    QBCore.Functions.Progressbar("use_heavyarmor", "Ağır zırh giyiyorsun....", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
