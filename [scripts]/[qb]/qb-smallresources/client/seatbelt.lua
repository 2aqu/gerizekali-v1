...
--             QBCore.Functions.Progressbar("harness_equip", "Kemer takılıyor...", 5000, false, true, {
...
--         else
--             LocalPlayer.state:set("inv_busy", true, true)
--             QBCore.Functions.Progressbar("harness_equip", "Kemer çıkartılıyor...", 5000, false, true, {
--                 disableMovement = false,
--                 disableCarMovement = false,
--                 disableMouse = false,
--                 disableCombat = true,
...
--         end
--     else
--         QBCore.Functions.Notify('Arabada değilsin.', 'error')
--     end
-- end)
...
-- RegisterKeyMapping('toggleseatbelt', 'Emniyet kemerini tak/çıkar', 'keyboard', 'K')
