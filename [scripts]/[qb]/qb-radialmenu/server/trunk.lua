...
QBCore.Commands.Add("bgir", Lang:t("general.getintrunk_command_desc"), {}, false, function(source)
    TriggerClientEvent('qb-trunk:client:GetIn', source)
end)

QBCore.Commands.Add("bcik", Lang:t("general.putintrunk_command_desc"), {}, false, function(source)
