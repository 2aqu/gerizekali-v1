local Translations = {
    error = {
        no_people_nearby = "Yakınında kimse yok.",
    ...
    general = {
        ...
        push_stretcher_button = "~g~E~w~ - Sedyeyi it",
        stop_pushing_stretcher_button = "~g~E~w~ - Sedyeyi bırak",
        lay_stretcher_button = "~g~G~w~ - Sedyeye uzan",
        push_position_drawtext = "Buraya it",
        get_off_stretcher_button = "~g~G~w~ - Sedyeden kalk",
