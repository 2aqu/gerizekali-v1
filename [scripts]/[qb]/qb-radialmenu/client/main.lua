...
local function IsPoliceOrEMS()
    return (PlayerData.job.name == "police" or PlayerData.job.name == "fbi" or PlayerData.job.name == "state" or PlayerData.job.name == "sheriff" or PlayerData.job.name == "ranger" or PlayerData.job.name == "davison" or PlayerData.job.name == "ambulance")
end
...
RegisterNetEvent('tasi-event', function()
    ExecuteCommand('taşı')
end)

RegisterNetEvent('bindir-event', function()
    ExecuteCommand('ybindir')
end)

RegisterNetEvent('bindir-kelepce', function()
    ExecuteCommand('araç')
end)
