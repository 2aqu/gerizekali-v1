...
QBCore.Commands.Add("cakalcar", "Repair your vehicle (Admin Only)", {}, false, function(source)
    TriggerClientEvent('iens:repaira', source)
    TriggerClientEvent('vehiclemod:client:fixEverything', source)
    TriggerEvent('qb-admin:server:SendLog', 'fix', 'yellow', 'Aracını fix ile tamir etti.', source)
end, "mod")
