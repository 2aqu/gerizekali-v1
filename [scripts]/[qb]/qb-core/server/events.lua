...
AddEventHandler('playerDropped', function(reason)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'joinleave', 'Sunucudan Çıkış Yaptı', 'red', '**'..Player.PlayerData.name .. ' (CitizenID: '..Player.PlayerData.citizenid..' | Isim: '.. Player.PlayerData.charinfo.firstname .. ' ' .. Player.PlayerData.charinfo.lastname ..' | ID: '..Player.PlayerData.source..')** \n **Sunucudan çıkış yaptı. Sebep:** ' .. reason)
