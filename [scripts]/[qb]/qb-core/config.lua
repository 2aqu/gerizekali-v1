...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 250, bank = 750, crypto = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
QBConfig.Player = {}
QBConfig.Player.HungerRate = 2.1 -- Rate at which hunger goes down.
QBConfig.Player.ThirstRate = 1.9 -- Rate at which thirst goes down.
...
QBConfig.Server.Permissions = { 'god', 'admin', 'mod', 'guide', 'support' } -- Add as many groups as you want here after creating them in your server.cfg
