...
RegisterNetEvent('qb-admin:client:SaveCar', function()
    ...
    if veh ~= nil and veh ~= 0 then
        ...
        local vehCat = exports['efearob-base']:getVehicleType(vehClass)

        print(GetDisplayNameFromVehicleModel(hash):lower())
        if QBCore.Shared.Vehicles[vehname] ~= nil and next(QBCore.Shared.Vehicles[vehname]) ~= nil then
            TriggerServerEvent('qb-admin:server:SaveCar', props, QBCore.Shared.Vehicles[vehname], GetHashKey(veh), plate, vehCat)
