...
Citizen["CreateThread"] (function()
    ...
    Citizen["CreateThread"] (function()
        ...
        RegisterNetEvent("nova_bilardo:syncTableState")
        AddEventHandler("nova_bilardo:syncTableState",function(t6697399,newTableData,isCueBallHit,hitStrength)
            ...
            Citizen["CreateThread"] (function()
                ...
                while ((t73265896==t31885809)==(t83527841==t41858126)) do 
                    ...
                    if t7697375==t10935101 then 
                        ...
                        if not t75552426 then 
                            t93314187=(t60302798 or t47486038)TriggerEvent("nova_bilardo:closeMenu")
                        end 
                    end 
                end end )
                ...
                Citizen["CreateThread"] (function()
                            ...
                            for t6697399,table in pairs(t99667691) do 
                                if t39425259==table["player"]  then 
                                    ...
                                    if not t47409820 and t7697375==t37745422 then 
                                        t7697375=t10935101 TriggerServerEvent("nova_bilardo:syncFinalTableState",t6697399,table["balls"] )
                                    end 
                                    break 
                                end 
                            end 
                    ...
                    RegisterNetEvent("nova_bilardo:internalNotification")
                    AddEventHandler("nova_bilardo:internalNotification",function(serverId,t6697399,t41717886)
...
RegisterNetEvent("nova_bilardo:turnGranted")
AddEventHandler("nova_bilardo:turnGranted",function(t6697399)
    ...
    if not t99667691[t6697399] ["balls"] [t99667691[t6697399] ["cueBallIdx"] ] ["disabled"]  then 
        ...
        TriggerServerEvent("nova_bilardo:setBallInHandData",t6697399,t99667691[t6697399] ["balls"] [t99667691[t6697399] ["cueBallIdx"] ] ["position"] )t2023733()t7697375=t18626986 t11374114((((`flashgt`|`coquette`)~(-1225006785))/1))
    end 
end )
    ...
    Citizen["CreateThread"] (function()
        ...
        while t7697375==t18626986 do 
            ...
            if (t14224655-t5926077)>((`sandking2`|`asbo`)~2063395499) then 
                TriggerServerEvent("nova_bilardo:setBallInHandData",t93314187,t78921246["position"] )t5926077=t14224655 
            end 
...
t42419088=((t32123608==t33806494)==(t70208044 and t21956173))t65186825=function(fromCam)
    ...
    Citizen["CreateThread"] (function()
        while t7697375==t69750738 do 
            ...
            if not t54293798 then 
                ...
                elseif _G["IsControlJustPressed"] ((`t20`~1663218586),t61549719(Config["Keys"] ["BACK"] ["code"] )) or _G["IsDisabledControlJustPressed"] ((`michelli`~1046206681),t61549719(Config["Keys"] ["BACK"] ["code"] )) then 
                    t7697375=t10935101 
                    TriggerServerEvent("nova_bilardo:releaseControl",t93314187)t5020611()
                end 
        ...
        if t70640960 then 
            ...
            TriggerServerEvent("nova_bilardo:syncCueBallVelocity",t93314187,t10639376["position"] ,t96722640,t70640960)_G["Wait"] ((`felon`~(-391594916)))
        end 
...
AddEventHandler("lsrp_pool:forceStopControl",function()
    if t7697375==t69750738 or t7697375==t18626986 then 
        t7697375=t10935101 TriggerServerEvent("nova_bilardo:releaseControl",t93314187)
    end 
end )
...
if not t61549719(Config["CustomMenu"] ) then 
            ...
            if t61549719(WarMenu)["IsMenuOpened"] ("pool") then 
                if t93314187 then 
                    ...
                    elseif t61549719(WarMenu)["Button"] (t61549719(Config["Text"] ["TYPE_STRAIGHT"] )) then 
                        TriggerEvent("nova_bilardo:setupTable","BALL_SETUP_STRAIGHT_POOL")t61549719(WarMenu)["CloseMenu"] ()
                    end 
    ...
    AddEventHandler("nova_bilardo:setupTable",function(ballNumbers)
        ...
        if ballNumbers=="BALL_SETUP_8_BALL" or ballNumbers=="BALL_SETUP_STRAIGHT_POOL" then 
            ...
            TriggerServerEvent("nova_bilardo:setTableState",{["tablePosition"]=_G["GetEntityCoords"] (t43068463),["data"]=t41778860})
        else
