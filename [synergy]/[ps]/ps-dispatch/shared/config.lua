...
Config.Locations = {
    ["HuntingZones"] = {
        [1] = {label = "Avcılık Bölgesi", radius = 650.0, coords = vector3(-938.61, 4823.99, 313.92)},
    },
    ["NoDispatchZones"] = {
        ...
        [3] = {label = "Pvp", coords = vector3(2304.84, 4863.68, 41.81), length = 300.0, width = 300.0, heading = 280, minZ = 35.62, maxZ = 52.62},
    },
}
