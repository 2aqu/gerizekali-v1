...
Config.Lang = {
    ...
    -- Client
    ["no_permission"] = "Sadece parti lideri bunu yapabilir!",
    ["keybind"] = 'İnşaat İşi İşareti Etkileşimi',
    ["too_far"] = "Partiniz işe başladı, ancak merkezden çok uzaktasınız",
    ["kicked"] = "%s kişisini partiden attınız",
    ["alreadyWorking"] = "Önceki görevi tamamlayın",
    ["quit"] = "Ekip'ten ayrıldınız",
    ["wrongCar"] = "Bu şirket aracınız değil",
    ...
    ["spawnpointOccupied"] = "Araç veya mikser kamyonunun doğuş noktası meşgul",
    ["pipesNotReady"] = "Betonu dökmek için önce boruları yerleştirmeniz gerekiyor",
    ["clickToPour"] = "~INPUT_CONTEXT~ tuşuna basarak beton dökün",
    ["installPipe"] = "Boru Yerleştir",
    ["pickupBlock"] = "Bloğu Kaldır",
    ["tutorialAfterMixerPickup"] = "Patronunuzun belirlediği beton mikserini aldınız. Şimdi onu inşaat sahasına götürün ve betonu belirlenen bölgelere dökün. İnşaat Alanı, GPS üzerinde işaretlenmiştir",
    ["startingTutorial"] = "İnşaat işçisi olarak hoş geldiniz. Kaynak yapmaktan, duvar inşa etmeye, kanalizasyon tesisatı yapmaktan, beton dökmeye kadar birçok görev sizi bekliyor. Eğer bir grup içinde çalışıyorsanız, bir kişiyi beton mikseri alım noktasına bırakmanız ve ardından beton mikserini inşaat sahasına taşımanız gerekecek. Her bir aktiviteye ilk yaklaştığınızda, size açıklama yapılacaktır. Görevlerin konumlarını haritada işaretledik. Tek başınıza çalışıyorsanız, her görevi kendi başınıza tamamlamanız gerekecek; grup içinde çalışıyorsanız, görevleri nasıl böleceğinize siz karar vereceksiniz. Tüm görevleri yapmanıza gerek yok, istediğiniz zaman bitirebilirsiniz ve ödemeniz yaptığınız görevlerin yüzdesine bağlı olacaktır. İyi şanslar dileriz!",
    ["installBlock"] = "Duvar İnşa Et",
    ["tutorialWallBuilding"] = "Duvar çerçevesinin yanındasınız, göreviniz beton bloklarını kullanarak duvarı inşa etmek. Beton blokları çerçevenin yakınında ve GPS üzerinde işaretlenmiştir. Blokların bulunduğu yığının yanına gidin, bir tane alın ve ardından duvara monte edin",
    ["tutorialAboutPipes"] = "Kanalizasyon borularını içeren bir çukurun yanındasınız. Göreviniz, boruları doğru yerlere yerleştirmektir. Boruları yerleştirdikten sonra, bir beton mikseri kullanarak çukurun üzerine beton dökmelisiniz.",
    ["tutorialWelding"] = "Kaynak yapmanızı istenen yerin yanındasınız. Görev çok basit ve başka bir açıklama gerektirmez",
    ["startWelding"] = "Kaynağa Başla",
    ["workstationOccupied"] = "Bu iş istasyonu meşgul",
    ...
    -- Server
    ["isAlreadyHost"] = "Bu oyuncu zaten ekibin lideri.",
    ["isBusy"] = "Bu oyuncu zaten başka bir ekibe aittir.",
    ...
    ["error"] = "Bir ekibe katılma konusunda bir sorun oluştu. Lütfen daha sonra tekrar deneyin.",
    ["kickedOut"] = "Ekibinizden atıldınız!",
    ["reward"] = "Sizden $ miktarında bir ödeme alındı.",
    ["RequireOneFriend"] = "Bu iş için en az bir ekibin üyesine ihtiyaç var.",
    ["penalty"] = "Bir ceza ödediniz, miktar: ",
    ["clientsPenalty"] = "Ekip lideri cezayı kabul etti. Siz ödemeyi almadınız.",
    ["noMixerStatus"] = "Şu anda sizin için uygun bir beton mikserimiz yok. Lütfen daha sonra tekrar deneyin.",
    ["dontHaveReqItem"] = "Siz veya ekibinizden biri, işe başlamak için gerekli olan öğeye sahip değil.",
    ["notEverybodyHasRequiredJob"] = "Arkadaşlarınızın her birinin gerekli işe sahip olmadığından emin olun.",
    ["someoneIsOnCooldown"] = "Siz veya ekibinizden biri şu anda işi yapamaz (cooldown: %s)",
    ["hours"] = "s",
    ["minutes"] = "dk",
    ["seconds"] = "sn",    
}
...
Config.JobBlipsStyle = {
    ["mixerSpawnLocation"] = {
        color = 47,
        string = "~o~[BUILDER]~s~ Kamyonet için beton karıştırıcı",
        sprite = 800,
    },
    ["mixerTargetLocation"] = {
        color = 47,
    ...
    ["blockPickup"] = {
        color = 47,
        string = "~o~[BUILDER]~s~ Duvar inşası için Pikap Blokları",
        sprite = 655, 
    },
    ["buildWall"] = {
        color = 47,
