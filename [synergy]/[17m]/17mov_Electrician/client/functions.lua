...
function StartMinigame(icons, time, difficulty)

    -- Difificulties are: "easy", "medium", "hard" :D

    return exports['Howdy-Minigame']:Begin(icons, time)
end
...
Config.WrongNotifications = {
    ...
    ["cantSpawn"] = true,
    ["failedHostSide"] = true,
    ["failedClientSide"] = true,
    ["dontGiveVehicle2ndTime"] = true,
    ["no_permission"] = true,
