...
window.addEventListener('message', function (event) {
    ...
    if (action == "addNewMember") {
        ...
        $("#counter").fadeOut(250)
        $(".header .bgText").text("POSTMAN LOBBY")
        $(".header .text").text("POSTMAN LOBBY")
        $("#inviteScreen").fadeOut(250)
        $("#warningScreen").fadeOut(250)
        $("#tutorialScreen").fadeOut(250)
        ...
        $("#counterValue").text(`Collected letters: ${0}`)
        $("#counter").fadeIn(250)
        counterActive = true
        ...
        $("#counterValue").text(`Collected letters: ${event.data.value.toString()}`)
