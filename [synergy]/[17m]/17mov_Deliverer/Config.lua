...
Config.Price = 800                                                  -- 100$ per one delivery
...
Config.Lang = {
    ...
    ["too_far"] = "Partiniz çalışmaya başladı, ancak merkezden çok uzaktasınız. Yine de onlara katılabilirsiniz.",
    ["kicked"] = "%s kişisini partiden attınız",
    ["alreadyWorking"] = "Önceki siparişi tamamlayın.",
    ["quit"] = "Ekipten ayrıldınız",
    ["cantSpawnVeh"] = "Kamyon doğuş noktası meşgul.",
    ["nobodyNearby"] = "Etrafta kimse yok",
    ["TargetCoords"] = "Teslimat Hedefi Koordinatları",
    ["deliverParcel"] = "Paketi Teslim Et",
    ["takeParcel"] = "Paketi Al",
    ["wait"] = "Şimdi birinin kapıyı açmasını bekleyin",
    ["missingParcel"] = "Üzerinizde bir paket yok. Arabadan alın.",
    ...
    ["tutorial"] = "İş, paketleri evlere teslim etmeyi içerir. Eğer bir ekip içinde çalışıyorsanız, bir kişi arabayı belirlenen yere sürerken, diğer kişi paketi bagajdan alır ve paketi eve teslim etmek üzere gider. Diğer yandan, tek başınıza çalışıyorsanız, her iki görevi de kendiniz yapmanız gerekecek. Ödeme, teslim edilen paket sayısına bağlıdır. İşi istediğiniz zaman bitirerek arabayı belirlenen yerde bırakarak üsse geri dönün.",
    ["partyIsFull"] = "Davet gönderilemedi, grubunuz dolu",
    ["inviteSent"] = "Davet Gönderildi!",
    ["tooFar"] = "Hedef konumdan çok uzaktasınız, paket almak için.",
    ...
    ["RequireOneFriend"] = "Bu iş için en az bir ekip üyesine ihtiyaç var.",
