...
Config.DisablePoliceScanner = false -- If true, disables the police radio/scanner/dispatch sounds.
...
Config.InstructionButtons = {
    ...
    [0] = { control = "~INPUT_662F7BF5~", label = "Marker Ekle/Kaldır" },
    [1] = { control = "~INPUT_DB471A88~", label = "Görüntüyü Değiştir" },
...
Config.Localisation = {
    ...
    Notification = {
        ...
        JobGrade = "İş sınıfınız çok düşük!",
        NoCameraHeli = "Bu helikopterde bir kamera yok!",
        NoCameraPlane = "Bu uçakta bir kamera yok!",
        IsPilot = "Pilotken kamerayı kullanamazsınız!",
        NotInRear = "Kamerayı kullanmak için helikopterin arka kısmında olmanız gerekiyor!",
        CameraInUse = "Başkası zaten kamerayı kullanıyor!",
        SpotlightInUse = "Başkası zaten kamera projektörünü kullanıyor!",
        NoSpotlight = "Bu helikopterde bir projektör yok!",
        SpotlightGlobalLimit = "Genel projektör sınırına ulaşıldı!",
        CannotRappelFromHeli = "Bu helikopterle iniş yapamazsınız!",
        CannotRappelFromSeat = "Bu koltuktan iniş yapamazsınız!",
        ToHighToRappel = "Helikopter çok yüksekte iniş yapamazsınız!",
        ConfirmRappel = "İniş yapmak istediğinizden emin misiniz? (Onaylamak için tekrar basın)",
        Rappeling = "İniş yapılıyor!"        
    },
    -- Blip Names
    Blip = {
        Target = "Helikopter Hedefi",
        Marker = "Helikopter İşareti"        
    },
    -- Keybinding Descriptions
    KeyMapping = {
        ToggleCam = "Helikopter - Kamerayı Aç/Kapat",
        AttemptLock = "Helikopter - Kilit Denemesi",
        CycleVision = "Helikopter - Görüntüyü Değiştir",
        ToggleMarker = "Helikopter - İşaretçi Ekle/Kaldır",
        Rappel = "Helikopter - Helikopterden İniş Yap",
        Spotlight = "Helikopter - Projektörü Aç/Kapat",
        SpotlightBrightness = "Helikopter - (+ kaydırma) Projektör Parlaklığını Ayarla",
        SpotlightRadius = "Helikopter - (+ kaydırma) Projektör Menzilini Ayarla",
        Postals = "Helikopter - Postaları Aç/Kapat"
        
    },
    ChatSuggestions = {
        ToggleCamera = "Helikopter kamerasına giriş/çıkış yap",
        Rappel = "Helikopterden iniş yap"        
    }
}
