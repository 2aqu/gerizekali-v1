...
RegisterCommand('heist', function()
    ...
    local _initialText = { --first slide. Consists of 3 text lines.
        missionTextLabel = "~y~Alan Ögrenildi~s~", 
        passFailTextLabel = "Kenevir TarlasI 1",
        messageLabel = "Bu alan bundan sonra haritanda görünecek.",
    }
...
RegisterNetEvent('eph:places:learn')
AddEventHandler('eph:places:learn', function(placeName)
        --All 4 tables are required in order to proprer syncronize the scaleform.
        local _initialText = { --first slide. Consists of 3 text lines.
        missionTextLabel = "~y~Alan Ögrenildi~s~", 
        passFailTextLabel = placeName,
        messageLabel = "Bu alan bundan sonra haritanda görünecek.",
    }
    local _table = { --second slide. You can add as many "stats" as you want. They will appear from botton to top, so keep that in mind.
        {stat = "", value = ""},
...
RegisterNetEvent('eph:sf:proxy')
AddEventHandler('eph:sf:proxy', function(mtlabel, seclabel, meslabel, sound)
        --All 4 tables are required in order to proprer syncronize the scaleform.
        local _initialText = { --first slide. Consists of 3 text lines.
        missionTextLabel = "~y~" .. mtlabel .. "~s~", 
        passFailTextLabel = seclabel,
        messageLabel = meslabel,
    }
    local _table = { --second slide. You can add as many "stats" as you want. They will appear from botton to top, so keep that in mind.
        {stat = "", value = ""},
        --{stat = "value3", value = "~g~$~s~50000"},
    ...
    TriggerEvent("cS.HeistFinale", _initialText, _table, _money, _xp, 10, sound)
end)
