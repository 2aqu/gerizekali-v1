...
Config.mufflerjob = 'mechanic15'
Config.engine_handling = false
...
Config.custom_engine = { 
	...
	-- advanced usage, Custom Engine, customsounds, custom handling (handling for engine speed and power only) -- the item can be spawn using engine_b16b for example. 
