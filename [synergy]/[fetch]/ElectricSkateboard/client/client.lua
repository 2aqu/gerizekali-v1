		...
		if DoesEntityExist(skateboard.Entity) then
			...
			Targets[#Targets+1] =
				exports["qb-target"]:AddTargetEntity(skateboard.Skate, { options = {
					{ event = "jim-skateboard:GetOn", icon = "fas fa-car", label = "Bin", board = skateboard.Skate },
					{ event = "jim-skateboard:PickPlace", icon = "fas fa-hand-holding", label = "Al", board = skateboard.Skate },
				}, distance = 2.5,	})
...
RegisterKeyMapping('skategetoff', 'Kaykaydan in', 'keyboard', 'G')
