function GetCore()
    ...
    if Config.Framework == "oldesx" then
        ...
        if not object then
            print("codem-bank:Framework is not selected in the config correctly if you're sure it's correct please check your events to get framework object")
        end
    end
    ...
    if Config.Framework == 'autodetect' then
        ...
        if not object then
            print("codem-bank:Framework object couldn't find. Setting chat to standalone")
        else
            print("codem-bank:Framework object found : ", Framework)
        end
    end
