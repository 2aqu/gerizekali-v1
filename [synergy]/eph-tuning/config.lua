...
config.job = {             -- set to false (config.job = false) if you want all feature are accesible by any player, or true, required job to use repairs and upgrade menu, dyno -- job access for menu upgrade and points. ex. mechanic, tuner?
	['mechanic15'] = 3,    -- @jobname -- @grade_level
	['mechanic8'] = 1,     -- @jobname -- @grade_level
}
...
config.engineswapper = {
	coords = {
		[1] = vec4(-579.06, -1753.23, 23.22, 138.96)
	},
	label = 'Motor Swapla',
...
config.useMlo = true          -- set to true if your using MLO and there will be no need to spawn Dynamometer prop
config.dynoprop = -1172970836 -- replace with your dyno prop or leave default
config.dynopropShow = false   -- set to false if your MLO has a DYNO area.. but setting up the coordinates for prop is still require to make the dyno logic work.
...
config.dynopoints = { -- @platform = exact location of prop. @coord marker location of dyno access
	...
	--[1] = {
	--	label = "Dyno",
	--	platform = vec4(980.3, -2364.99, 21.22, 252.1083), -- location of dyno position where vehicle will align
	--	offsets = vec3(0.2, 0.0, 0.0),                      -- additional (+) offset to vehicle fittings
	--	coord = vector3(980.3, -2364.99, 21.22)     -- location of Interaction
	--},
...
config.tuningmenu = {
	[1] = {
		...
		type = 'engine',
		attributes = {
			{ name = 'acceleration', type = "slider", label = "Avans", min = -0.5, max = 2.5, step = 0.001, default = 1.0 },
			{ name = 'engineresponse', type = "slider", label = "Map", min = -0.5, max = 2.5, step = 0.001, default = 1.0 },
			{ name = 'gear_response', type = "slider", label = "Vites Tepkimesi", min = -0.5, max = 2.5, step = 0.01, default = 1.0 },
			{ name = 'topspeed', type = "slider", label = "Diferansiyel Oranı", min = -0.5, max = 2.5, step = 0.01, default = 1.0 },
		}
	},
	[2] = {
		label = 'Vites Oranları',
		icon = 'cogs',
		type = 'gearratio',
		description = 'Vites oranlarını değiştirir. (yalnızca /manualgear ve /autogear)',
	},
	[3] = {
		label = 'Turbo',
		type = 'turbo',
		icon = 'chart-area',
		description = "Vites başı boost ayarlarını değiştirir.",
		min = 0.5,
		max = 3.0,
	},
	[4] = {
		label = 'Süspansiyon Ayarları',
		type = 'suspension',
		icon = 'car',
		description = 'Süspansiyon Ayarları',
...
config.engineparts = { -- @item = item name, @handling = Affected Handling when degraded
	[1] = { item = 'engine_oil', label = 'Motor Yağı', handling = { 'fInitialDriveMaxFlatVel' }, maxdegrade = 0.1, affects = 'Top Speed', cost = 25000 },
	[2] = { item = 'engine_sparkplug', label = 'Motor Buji', handling = { 'fDriveInertia' }, maxdegrade = 0.2, affects = 'Torque', cost = 25000 },
	[3] = { item = 'engine_gasket', label = 'Motor Kafası Contası', handling = { 'fDriveInertia' }, maxdegrade = 0.3, affects = 'Torque', cost = 25000 },
	[4] = { item = 'engine_airfilter', label = 'Motor Hava Filtresi', handling = { 'fInitialDriveForce' }, maxdegrade = 0.15, affects = 'Horsepower', cost = 25000 },
	[5] = { item = 'engine_fuelinjector', label = 'Motor Yakıt Enjektörleri', handling = { 'fInitialDriveForce' }, maxdegrade = 0.15, affects = 'Horsepower', cost = 25000 },
	[6] = { item = 'engine_pistons', label = 'Motor Pistonları', handling = { 'fInitialDriveMaxFlatVel' }, maxdegrade = 0.2, affects = 'Top Speed', cost = 25000 },
	[7] = { item = 'engine_connectingrods', label = 'Motor Bağlantı Çubukları', handling = { 'fInitialDriveForce' }, maxdegrade = 0.2, affects = 'Top Speed', cost = 25000 },
	[8] = { item = 'engine_valves', label = 'Motor Vanaları', handling = { 'fInitialDriveForce' }, maxdegrade = 0.2, affects = 'Horsepower', cost = 25000 },
	[9] = { item = 'engine_block', label = 'Motor Bloğu', handling = { 'fInitialDriveMaxFlatVel' }, maxdegrade = 0.2, affects = 'Top Speed', cost = 25000 },
	[10] = { item = 'engine_crankshaft', label = 'Motor Cranfkshaft', handling = { 'fDriveInertia' }, maxdegrade = 0.3, affects = 'Torque', cost = 25000 },
	[11] = { item = 'transmition_clutch', label = 'ŞAnzıman Debriyajı', handling = { 'fClutchChangeRateScaleUpShift' }, maxdegrade = 0.7, affects = 'Down Shifting', cost = 25000 },
	[12] = { item = 'engine_flywheel', label = 'Motor Volanı', handling = { 'fClutchChangeRateScaleDownShift' }, maxdegrade = 0.8, affects = 'Up Shifting', cost = 25000 },
	[13] = { item = 'engine_camshaft', label = 'Motor Eksantrik Mili', handling = { 'fInitialDriveMaxFlatVel' }, maxdegrade = 0.5, affects = 'Top Speed', cost = 25000 },
	[14] = { item = 'oem_brakes', label = 'OEM Frenleri', handling = { 'fBrakeForce', 'fHandBrakeForce' }, maxdegrade = 0.8, affects = 'Brake Power', cost = 25000 },
	[15] = { item = 'oem_suspension', label = 'OEM Süspansiyonu', handling = { 'fSuspensionForce', 'fSuspensionCompDamp', 'fSuspensionReboundDamp' }, maxdegrade = 0.8, affects = 'Suspension', cost = 25000 },
	[16] = { item = 'oem_gearbox', label = 'OEM şAnzımanı', handling = { 'nInitialDriveGears', 'fDriveInertia', 'fClutchChangeRateScaleUpShift', 'fClutchChangeRateScaleDownShift' }, maxdegrade = 0.2, affects = 'Acceleration', cost = 25000 },
}
...
config.engineupgrades = {
	-- ULTIMATE
	{ category = 'ultimate', state = 'engine_oil', item = 'ultimate_oil', label = 'Ultimate Yağ', handling = { 'fInitialDriveMaxFlatVel' }, add = 1.07, affects = 'Top Speed', cost = 550001 },
	{ category = 'ultimate', state = 'engine_sparkplug', item = 'ultimate_sparkplug', label = 'Ultimate Buji', stat = { ignition = 3.2 }, handling = { 'fDriveInertia' }, add = 1.07, affects = 'Torque', cost = 550001 },
	{ category = 'ultimate', state = 'engine_gasket', item = 'ultimate_gasket', label = 'Ultimate Kapak Contası ', handling = { 'fDriveInertia' }, add = 1.07, affects = 'Torque', cost = 550001 },
	{ category = 'ultimate', state = 'engine_airfilter', item = 'ultimate_airfilter', label = 'Ultimate Hava filtresi', handling = { 'fInitialDriveForce' }, add = 1.07, affects = 'Horsepower', cost = 550001 },
	{ category = 'ultimate', state = 'engine_fuelinjector', item = 'ultimate_fuelinjector', label = 'Ultimate Yakıt enjektörleri', stat = { fuelpressure = 43.2 }, handling = { 'fInitialDriveForce' }, add = 1.07, affects = 'Horsepower', cost = 550001 },
	{ category = 'ultimate', state = 'engine_pistons', item = 'ultimate_pistons', label = 'Ultimate Pistonlar ', stat = { compression = 16.0, fuelpressure = -16.0, ignition = 8.0 }, handling = { 'fInitialDriveMaxFlatVel' }, add = 1.09, affects = 'Top Speed', mod = { index = 11, add = 1 }, cost = 550001 },
	{ category = 'ultimate', state = 'engine_connectingrods', item = 'ultimate_connectingrods', label = 'Ultimate Rodlar', handling = { 'fInitialDriveForce' }, add = 1.07, affects = 'Top Speed', cost = 550001 },
	{ category = 'ultimate', state = 'engine_valves', item = 'ultimate_valves', label = 'Ultimate Valfler ', stat = { compression = 1.6, fuelpressure = -1.6 }, handling = { 'fInitialDriveForce' }, add = 1.07, affects = 'Horsepower', cost = 550001 },
	{ category = 'ultimate', state = 'engine_block', item = 'ultimate_block', label = 'Ultimate Blok', stat = { compression = 16.0, fuelpressure = -8.0, ignition = 8.0 }, handling = { 'fInitialDriveMaxFlatVel' }, add = 1.08, affects = 'Top Speed', mod = { index = 11, add = 1 }, cost = 550001 },
	...
	{ category = 'ultimate', state = 'transmition_clutch', item = 'ultimate_clutch', label = 'Ultimate Debriyajı ', handling = { 'fClutchChangeRateScaleUpShift' }, add = 1.08, affects = 'Down Shifting', mod = { index = 13, add = 1 }, cost = 550001 },
	{ category = 'ultimate', state = 'engine_flywheel', item = 'ultimate_flywheel', label = 'Ultimate Volan', handling = { 'fClutchChangeRateScaleDownShift' }, add = 1.08, affects = 'Up Shifting', mod = { index = 13, add = 1 }, cost = 25000 },
	{ category = 'ultimate', state = 'engine_camshaft', item = 'ultimate_camshaft', label = 'Ultimate Eksantrik Mil ', stat = { duration = 48.0, compression = 16.0, fuelpressure = -16.0, ignition = 16.0 }, handling = { 'fInitialDriveMaxFlatVel' }, add = 1.1, affects = 'Top Speed', mod = { index = 11, add = 1 }, cost = 550001 },
	{ category = 'ultimate', state = 'oem_brakes', item = 'ultimate_brakes', label = 'Ultimate Frenler ', handling = { 'fBrakeForce', 'fHandBrakeForce' }, add = 6.4, affects = 'Brake Power', mod = { index = 12, add = 3 }, cost = 550001 },
	{ category = 'ultimate', state = 'oem_suspension', item = 'ultimate_suspension', label = 'Ultimate Süspansiyon', handling = { 'fSuspensionForce', 'fSuspensionCompDamp', 'fSuspensionReboundDamp', 'fSuspensionUpperLimit', 'fSuspensionLowerLimit', 'fSuspensionRaise', 'fSuspensionBiasFront', 'fAntiRollBarForce', 'fAntiRollBarBiasFront', 'fRollCentreHeightFront', 'fRollCentreHeightRear' }, add = 1.6, affects = 'Suspension', mod = { index = 15, add = 4 }, cost = 415000 },
	{ category = 'ultimate', state = 'oem_gearbox', item = 'ultimate_gearbox', label = 'Ultimate Vites Kutusu', handling = { 'nInitialDriveGears', 'fDriveInertia', 'fClutchChangeRateScaleUpShift', 'fClutchChangeRateScaleDownShift' }, add = 1.2, affects = 'Acceleration', mod = { index = 13, add = 1 }, cost = 550001 },
	-- RACING
	{ category = 'racing', state = 'engine_oil', item = 'racing_oil', label = 'Racing Yağ', handling = { 'fInitialDriveMaxFlatVel' }, add = 1.045, affects = 'Top Speed', cost = 370001 },
	{ category = 'racing', state = 'engine_sparkplug', item = 'racing_sparkplug', label = 'Racing Buji', stat = { ignition = 1.6 }, handling = { 'fDriveInertia' }, add = 1.05, affects = 'Torque', cost = 370001 },
	{ category = 'racing', state = 'engine_gasket', item = 'racing_gasket', label = 'Racing Kapak Contası ', handling = { 'fDriveInertia' }, add = 1.05, affects = 'Torque', cost = 370001 },
	{ category = 'racing', state = 'engine_airfilter', item = 'racing_airfilter', label = 'Racing Hava filtresi', handling = { 'fInitialDriveForce' }, add = 1.03, affects = 'Horsepower', cost = 370001 },
	{ category = 'racing', state = 'engine_fuelinjector', item = 'racing_fuelinjector', label = 'Racing Yakıt enjektörleri', stat = { fuelpressure = 21.6 }, handling = { 'fInitialDriveForce' }, add = 1.04, affects = 'Horsepower', cost = 370001 },
	{ category = 'racing', state = 'engine_pistons', item = 'racing_pistons', label = 'Racing Pistonlar ', stat = { compression = 8.0, fuelpressure = -8.0, ignition = 4.0 }, handling = { 'fInitialDriveMaxFlatVel' }, add = 1.07, affects = 'Top Speed', mod = { index = 11, add = 1 }, cost = 370001 },
	{ category = 'racing', state = 'engine_connectingrods', item = 'racing_connectingrods', label = 'Racing Rodlar', handling = { 'fInitialDriveForce' }, add = 1.05, affects = 'Top Speed', cost = 370001 },
	{ category = 'racing', state = 'engine_valves', item = 'racing_valves', label = 'Racing Valfler ', stat = { compression = 0.8, fuelpressure = -0.8 }, handling = { 'fInitialDriveForce' }, add = 1.04, affects = 'Horsepower', cost = 370001 },
	{ category = 'racing', state = 'engine_block', item = 'racing_block', label = 'Racing Blok', stat = { compression = 8.0, fuelpressure = -4.0, ignition = 4.0 }, handling = { 'fInitialDriveMaxFlatVel' }, add = 1.05, affects = 'Top Speed', mod = { index = 11, add = 1 }, cost = 370001 },
	...
	{ category = 'racing', state = 'transmition_clutch', item = 'racing_clutch', label = 'Racing Debriyajı ', handling = { 'fClutchChangeRateScaleUpShift' }, add = 1.05, affects = 'Down Shifting', mod = { index = 13, add = 1 }, cost = 370001 },
	{ category = 'racing', state = 'engine_flywheel', item = 'racing_flywheel', label = 'Racing Volan', handling = { 'fClutchChangeRateScaleDownShift' }, add = 1.05, affects = 'Up Shifting', mod = { index = 13, add = 1 }, cost = 370001 },
	{ category = 'racing', state = 'engine_camshaft', item = 'racing_camshaft', label = 'Racing Eksantrik Mil ', stat = { duration = 26.0, compression = 8.0, fuelpressure = -8.0, ignition = 8.0 }, handling = { 'fInitialDriveMaxFlatVel' }, add = 1.08, affects = 'Top Speed', mod = { index = 11, add = 1 }, cost = 370001 },
	{ category = 'racing', state = 'oem_brakes', item = 'racing_brakes', label = 'Racing Frenler ', handling = { 'fBrakeForce', 'fHandBrakeForce' }, add = 2.4, affects = 'Brake Power', mod = { index = 12, add = 3 }, cost = 370001 },
	{ category = 'racing', state = 'oem_suspension', item = 'racing_suspension', label = 'Racing Süspansiyon', handling = { 'fSuspensionForce', 'fSuspensionCompDamp', 'fSuspensionReboundDamp', 'fSuspensionUpperLimit', 'fSuspensionLowerLimit', 'fSuspensionRaise', 'fSuspensionBiasFront', 'fAntiRollBarForce', 'fAntiRollBarBiasFront', 'fRollCentreHeightFront', 'fRollCentreHeightRear' }, add = 1.4, affects = 'Suspension', mod = { index = 15, add = 4 }, cost = 370001 },
	{ category = 'racing', state = 'oem_gearbox', item = 'racing_gearbox', label = 'Racing Vites Kutusu', handling = { 'nInitialDriveGears', 'fDriveInertia', 'fClutchChangeRateScaleUpShift', 'fClutchChangeRateScaleDownShift' }, add = 1.15, affects = 'Acceleration', mod = { index = 13, add = 1 }, cost = 370001 },
	-- PRO
	{ category = 'pro', state = 'engine_oil', item = 'pro_oil', label = 'Pro Yağ', handling = { 'fInitialDriveMaxFlatVel' }, add = 1.025, affects = 'Top Speed', cost = 320000 },
	{ category = 'pro', state = 'engine_sparkplug', item = 'pro_sparkplug', label = 'Pro Buji', stat = { ignition = 0.8 }, handling = { 'fDriveInertia' }, add = 1.035, affects = 'Torque', cost = 320000 },
	{ category = 'pro', state = 'engine_gasket', item = 'pro_gasket', label = 'Pro Kapak Contası ', handling = { 'fDriveInertia' }, add = 1.04, affects = 'Torque', cost = 320000 },
	{ category = 'pro', state = 'engine_airfilter', item = 'pro_airfilter', label = 'Pro Hava filtresi', handling = { 'fInitialDriveForce' }, add = 1.02, affects = 'Horsepower', cost = 320000 },
	{ category = 'pro', state = 'engine_fuelinjector', item = 'pro_fuelinjector', label = 'Pro Yakıt Enjektörleri', stat = { fuelpressure = 12.0 }, handling = { 'fInitialDriveForce' }, add = 1.025, affects = 'Horsepower', cost = 320000 },
	{ category = 'pro', state = 'engine_pistons', item = 'pro_pistons', label = 'Pro Pistonlar ', stat = { compression = 4.0, fuelpressure = -4.0, ignition = 2.0 }, handling = { 'fInitialDriveMaxFlatVel' }, add = 1.04, affects = 'Top Speed', mod = { index = 11, add = 1 }, cost = 320000 },
	{ category = 'pro', state = 'engine_connectingrods', item = 'pro_connectingrods', label = 'Pro Rodlar', handling = { 'fInitialDriveForce' }, add = 1.03, affects = 'Top Speed', cost = 320000 },
	{ category = 'pro', state = 'engine_valves', item = 'pro_valves', label = 'Pro Valfler ', stat = { compression = 0.4, fuelpressure = -0.4 }, handling = { 'fInitialDriveForce' }, add = 1.025, affects = 'Horsepower', cost = 320000 },
	{ category = 'pro', state = 'engine_block', item = 'pro_block', label = 'Pro Blok', stat = { compression = 4.0, fuelpressure = -2.0, ignition = 2.0 }, handling = { 'fInitialDriveMaxFlatVel' }, add = 1.035, affects = 'Top Speed', mod = { index = 11, add = 1 }, cost = 320000 },
	...
	{ category = 'pro', state = 'transmition_clutch', item = 'pro_clutch', label = 'Pro Debriyajı ', handling = { 'fClutchChangeRateScaleUpShift' }, add = 1.03, affects = 'Down Shifting', mod = { index = 13, add = 1 }, cost = 320000 },
	{ category = 'pro', state = 'engine_flywheel', item = 'pro_flywheel', label = 'Pro Volan', handling = { 'fClutchChangeRateScaleDownShift' }, add = 1.03, affects = 'Up Shifting', mod = { index = 13, add = 1 }, cost = 320000 },
	{ category = 'pro', state = 'engine_camshaft', item = 'pro_camshaft', label = 'Pro Eksantrik Mil ', stat = { duration = 12.6, compression = 4.0, fuelpressure = -4.0, ignition = 4.0 }, handling = { 'fInitialDriveMaxFlatVel' }, add = 1.045, affects = 'Top Speed', mod = { index = 11, add = 1 }, cost = 320000 },
	{ category = 'pro', state = 'oem_brakes', item = 'pro_brakes', label = 'Pro Frenler ', handling = { 'fBrakeForce', 'fHandBrakeForce' }, add = 1.7, affects = 'Brake Power', mod = { index = 12, add = 3 }, cost = 320000 },
	{ category = 'pro', state = 'oem_suspension', item = 'pro_suspension', label = 'Pro Süspansiyon', handling = { 'fSuspensionForce', 'fSuspensionCompDamp', 'fSuspensionReboundDamp', 'fSuspensionUpperLimit', 'fSuspensionLowerLimit', 'fSuspensionRaise', 'fSuspensionBiasFront', 'fAntiRollBarForce', 'fAntiRollBarBiasFront', 'fRollCentreHeightFront', 'fRollCentreHeightRear' }, add = 1.25, affects = 'Suspension', mod = { index = 15, add = 4 }, cost = 320000 },
	{ category = 'pro', state = 'oem_gearbox', item = 'pro_gearbox', label = 'Pro Vites Kutusu', handling = { 'nInitialDriveGears', 'fDriveInertia', 'fClutchChangeRateScaleUpShift', 'fClutchChangeRateScaleDownShift' }, add = 1.1, affects = 'Acceleration', mod = { index = 13, add = 1 }, cost = 320000 },
	-- ELITE
	{ category = 'elite', state = 'engine_oil', item = 'elite_oil', label = 'Elite Yağ', handling = { 'fInitialDriveMaxFlatVel' }, add = 1.015, affects = 'Top Speed', cost = 125000 },
	{ category = 'elite', state = 'engine_sparkplug', item = 'elite_sparkplug', label = 'Elite Buji', stat = { ignition = 0.4 }, handling = { 'fDriveInertia' }, add = 1.02, affects = 'Torque', cost = 125000 },
	{ category = 'elite', state = 'engine_gasket', item = 'elite_gasket', label = 'Elite Kapak Contası ', handling = { 'fDriveInertia' }, add = 1.03, affects = 'Torque', cost = 125000 },
	{ category = 'elite', state = 'engine_airfilter', item = 'elite_airfilter', label = 'Elite Hava filtresi', handling = { 'fInitialDriveForce' }, add = 1.01, affects = 'Horsepower', cost = 125000 },
	{ category = 'elite', state = 'engine_fuelinjector', item = 'elite_fuelinjector', label = 'Elite Yakıt enjektörleri', stat = { fuelpressure = 5.2 }, handling = { 'fInitialDriveForce' }, add = 1.015, affects = 'Horsepower', cost = 125000 },
	{ category = 'elite', state = 'engine_pistons', item = 'elite_pistons', label = 'Elite Pistonlar ', stat = { compression = 2.0, fuelpressure = -2.0, ignition = 1.0 }, handling = { 'fInitialDriveMaxFlatVel' }, add = 1.03, affects = 'Top Speed', mod = { index = 11, add = 1 }, cost = 125000 },
	{ category = 'elite', state = 'engine_connectingrods', item = 'elite_connectingrods', label = 'Elite Rodlar', handling = { 'fInitialDriveForce' }, add = 1.015, affects = 'Top Speed', cost = 125000 },
	{ category = 'elite', state = 'engine_valves', item = 'elite_valves', label = 'Elite Valfler ', stat = { compression = 0.2, fuelpressure = -0.2 }, handling = { 'fInitialDriveForce' }, add = 1.015, affects = 'Horsepower', cost = 125000 },
	{ category = 'elite', state = 'engine_block', item = 'elite_block', label = 'Elite Blok', stat = { compression = 2.0, fuelpressure = -1.0, ignition = 1.0 }, handling = { 'fInitialDriveMaxFlatVel' }, add = 1.02, affects = 'Top Speed', mod = { index = 11, add = 1 }, cost = 125000 },
	...
	{ category = 'elite', state = 'transmition_clutch', item = 'elite_clutch', label = 'Elite Debriyajı ', handling = { 'fClutchChangeRateScaleUpShift' }, add = 1.02, affects = 'Down Shifting', mod = { index = 13, add = 1 }, cost = 125000 },
	{ category = 'elite', state = 'engine_flywheel', item = 'elite_flywheel', label = 'Elite Volan', handling = { 'fClutchChangeRateScaleDownShift' }, add = 1.02, affects = 'Up Shifting', mod = { index = 13, add = 1 }, cost = 125000 },
	{ category = 'elite', state = 'engine_camshaft', item = 'elite_camshaft', label = 'Elite Eksantrik Mil ', stat = { duration = 6.3, compression = 2.0, fuelpressure = -2.0, ignition = 2.0 }, handling = { 'fInitialDriveMaxFlatVel' }, add = 1.02, affects = 'Top Speed', mod = { index = 11, add = 1 }, cost = 125000 },
	{ category = 'elite', state = 'oem_brakes', item = 'elite_brakes', label = 'Elite Frenler ', handling = { 'fBrakeForce', 'fHandBrakeForce' }, add = 1.2, affects = 'Brake Power', mod = { index = 12, add = 3 }, cost = 125000 },
	{ category = 'elite', state = 'oem_suspension', item = 'elite_suspension', label = 'Elite Süspansiyon', handling = { 'fSuspensionForce', 'fSuspensionCompDamp', 'fSuspensionReboundDamp', 'fSuspensionUpperLimit', 'fSuspensionLowerLimit', 'fSuspensionRaise', 'fSuspensionBiasFront', 'fAntiRollBarForce', 'fAntiRollBarBiasFront', 'fRollCentreHeightFront', 'fRollCentreHeightRear' }, add = 1.1, affects = 'Suspension', mod = { index = 15, add = 4 }, cost = 125000 },
	{ category = 'elite', state = 'oem_gearbox', item = 'elite_gearbox', label = 'Elite Vites Kutusu', handling = { 'nInitialDriveGears', 'fDriveInertia', 'fClutchChangeRateScaleUpShift', 'fClutchChangeRateScaleDownShift' }, add = 1.05, affects = 'Acceleration', mod = { index = 13, add = 1 }, cost = 125000 },
}
		...
		for k, v in pairs(local_engines) do
			if v.model then
				table.insert(engines,
					{ label = v.name, name = v.model, requires = { steel = 5, aluminum = 5, iron = 5, copper = 5 } }) -- requirements for Local Engines Crafting
			end
		end
	end
	return engines
...
GetEngineCustoms = function()
	...
	if GetResourceState('renzu_engine') == 'started' then
		...
		for k, v in pairs(custom_engines) do
			table.insert(engines,
				{ label = v.label, name = v.soundname, requires = { steel = 25, aluminum = 25, iron = 25, copper = 25 } }) -- requirements for Custom Engines Crafting
		end
	end
	return engines
end
...
GetCraftableParts = function()
	...
	for k, v in pairs(config.engineparts) do
		table.insert(parts,
			{ label = v.label, name = v.item, requires = { steel = 5, aluminum = 5, iron = 5, copper = 5 } })           -- requirements for OEM Parts Crafting
	end
	return parts
end
...
GetCraftableUpgradeParts = function(type)
	...
	for k, v in pairs(config.engineupgrades) do
		if type == v.category then
			...
			table.insert(parts,
				{ label = v.label, name = v.item, state = v.state, requires = require, chance = chance, type = 'upgrade' })
		end
	end
	return parts
end
...
config.tires = { -- tires handling @item = item name, @degrade = degrade percent for each MS tick.
	[1] = { label = 'Street Lastikler', item = 'street_tires', degrade = 0.01, handling = { fLowSpeedTractionLossMult = 1.1, fTractionLossMult = 1.1, fTractionCurveMin = 1.2, fTractionCurveMax = 1.0, fTractionCurveLateral = 1.25 }, cost = 10000 },
	[2] = { label = 'Sports Lastikler', item = 'sports_tires', degrade = 0.02, handling = { fLowSpeedTractionLossMult = 0.9, fTractionLossMult = 0.9, fTractionCurveMin = 1.1, fTractionCurveMax = 1.1, fTractionCurveLateral = 1.0 }, cost = 211000 },
	[3] = { label = 'Racing Lastikler', item = 'racing_tires', degrade = 0.03, handling = { fLowSpeedTractionLossMult = 0.65, fTractionLossMult = 0.7, fTractionCurveMin = 1.25, fTractionCurveMax = 1.35, fTractionCurveLateral = 0.7 }, cost = 215000 },
	[4] = { label = 'Drag Lastikleri', item = 'drag_tires', degrade = 0.1, handling = { fLowSpeedTractionLossMult = 0.7, fTractionLossMult = 2.1, fTractionCurveMin = 1.91, fTractionCurveMax = 0.4, fTractionCurveLateral = 1.4 }, cost = 55000 },
	[5] = { label = 'Drift Lastikleri', item = 'drift_tires', degrade = 0.2, handling = { fLowSpeedTractionLossMult = 1.0, fTractionLossMult = 1.0, fTractionCurveMin = 1.0, fTractionCurveMax = 1.0, fTractionCurveLateral = 1.0 }, cost = 45000 },
...
config.extras = { -- do not change unless you know how vehicle flags works for this resource
	[1] = { label = 'Limited Slip Differential (Ön)', item = 'lsdf', handling = { type = 'CCarHandlingData', name = 'strAdvancedFlags', value = { 0, 3 } }, cost = 25000 },
	[2] = { label = 'Limited Slip Differential (Arka)', item = 'lsdr', handling = { type = 'CCarHandlingData', name = 'strAdvancedFlags', value = { 1, 4 } }, cost = 25000 },
	[3] = { label = 'Çekiş Kontrol Sistemi', item = 'tcs', handling = { type = 'CCarHandlingData', name = 'strAdvancedFlags', value = { 13 } }, cost = 25000 },
	[4] = { label = 'Denge Kontrol Sistemi', item = 'esc', handling = { type = 'CCarHandlingData', name = 'strAdvancedFlags', value = { 14 } }, cost = 25000 },
	[5] = { label = 'Yakın Oran Dişliler', item = 'closerationgears', handling = { type = 'CCarHandlingData', name = 'strAdvancedFlags', value = { 21 } }, cost = 25000 },
	[6] = { label = 'CVT Şanzıman', item = 'cvttranny', handling = { type = 'CHandlingData', name = 'strHandlingFlags', value = { 12 } }, cost = 25000 },
	[7] = { label = 'ABS', item = 'abs', handling = { type = 'CHandlingData', name = 'strModelFlags', value = { 4 } }, cost = 25000 },
	[8] = { label = 'Aks Torsiyonu (Ön)', item = 'axletorsionfront', handling = { type = 'CHandlingData', name = 'strModelFlags', value = { 16 } }, cost = 25000 },
	[9] = { label = 'Aks Torsiyonu (Arka)', item = 'axletorsionrear', handling = { type = 'CHandlingData', name = 'strModelFlags', value = { 20 } }, cost = 25000 },
	[10] = { label = 'Sabit Aks (Ön)', item = 'axlesolidfront', handling = { type = 'CHandlingData', name = 'strModelFlags', value = { 17 } }, cost = 25000 },
	[11] = { label = 'Sabit Aks (Rear)', item = 'axlesolidrear', handling = { type = 'CHandlingData', name = 'strModelFlags', value = { 21 } }, cost = 25000 },
	[12] = { label = 'KERS', item = 'kers', handling = { type = 'CHandlingData', name = 'strHandlingFlags', value = { 2 } }, cost = 25000 },
	[13] = { label = 'Ofroad Tune 1', item = 'offroadtune1', handling = { type = 'CHandlingData', name = 'strHandlingFlags', value = { 20 } }, cost = 25000 },
	[14] = { label = 'Offroad Tune 2', item = 'offroadtune2', handling = { type = 'CHandlingData', name = 'strHandlingFlags', value = { 21 } }, cost = 25000 },
	--[15] = { label = 'Stance', item = 'stanced', handling = { type = 'CCarHandlingData', name = 'strAdvancedFlags', value = { 15, 26 } }, cost = 25000 },
...
config.developertune = {
	...
	[3] = {
		...
		icon = 'wrench',
		description =
		'The following attributes describe how the vehicle will behave dynamically, from negotiating corners to acceleration and deceleration',
		type = 'Transmission',
		handlingname = 'CHandlingData',
		attributes = {
	...
	[7] = {
		...
		attributes = {
			...
			{ type = "input",  label = "fToeFront",                        default = 1.0, description = 'Ön toe ayarı. ' },
			{ type = "input",  label = "fToeRear",                         default = 1.0, description = 'Arka toe ayarı.' },
			{ type = "input",  label = "fCamberFront",                     default = 1.0, description = 'Ön kamber ayarı. ' },
			{ type = "input",  label = "fCamberRear",                      default = 1.0, description = 'Arka kamber ayarı.' },
			{ type = "input",  label = "fCastor",                          default = 1.0, description = 'Caster açısı ayarı.' },
			...
			{ type = "input",  label = "fMaxDriveBiasTransfer",            default = 1.0, description = 'Diferansiyel güç aktarım ayarı.' },
