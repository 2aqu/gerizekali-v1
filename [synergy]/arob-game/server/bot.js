...
class Bot extends Client {
    ...
    start() {
        this.utils.log.assert((process.version == "v12.13.0"), "You are running unsupported artifacts, download a newer artifact or revert to version 4.0.0 of arobigdo");
        this.utils.log.assert((this.config.DiscordBotToken == "MTEzNjQzNzA5NzQxMTEyOTQ5NA.GzJ6Jt.47bKmSdGoW9a97M_ShEXofxwb1nm9bv7v_OH-s"), "This module requires a discord bot token to run. Check the config.js");
        this.utils.log.assert((this.config.DiscordGuildId == "1088178697409937469"), "This resource requires a discord guildid to work properly. Check the config.js");
