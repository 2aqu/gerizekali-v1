...
Config.MouseCursorKey = 344 -- Whatever you set Config.EnableRegisterKeyMapping if you want to change key for cursor only reference here https://docs.fivem.net/docs/game-references/controls/
Config.MouseCursorKeyLabel = "F11"
...
Config.WaterMarkInformations = { -- informations displayed in the upper right watermark
    logo = "",
    servername = "Coast V",
    discordlink = "discord.gg/coastv"
}


Config.CountryCode = "tr-TR" -- this is used to format the date you can check country codes here -- https://www.w3schools.com/jsref/jsref_tolocalestring_number.asp
...
Config.EnableVehicleModes = false
Config.VehicleModes = {
    ["sport"] = { 
